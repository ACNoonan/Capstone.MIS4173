  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a href="#">Logged In Owner</a>
        <ul>
            <li><a href="#">Job Overview</a></li>
            <li><a href="#">Order Statistics</a></li>
            <li><a href="#">Customer Statistics</a></li>
            <li><a href="#">Runner Statistics</a></li>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/courier5.png'); background-position:center;">
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      ...
      <footer><a class="btn" href="#">Request Your Document Delivery</a></footer>
    </article>
    <!-- ################################################################################################ -->
  </div>
</div>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/river1.jpg'); background-position:center;">
  <div class="hoc container clear"> 
    ...
    <div class="flexslider testimonials">
      <ul class="slides">
        <li>
          <article><img class="circle" src="images/demo/jane2.jpg" alt="">
